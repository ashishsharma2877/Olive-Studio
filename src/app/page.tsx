  ...
  return (
    <div className="bg-[#0A0A0F]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#00D4FF]/20 rounded-full blur-[128px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#8B5CF6]/20 rounded-full blur-[128px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/product"
                className="w-full sm:w-auto px-8 py-4 text-base font-semibold rounded-lg bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-[#0A0A0F] hover:opacity-90 transition-all hover:scale-105"
              >
                See How It Works
              </Link>
              <Link
              ...
              >
                ...
                >
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${useCase.color.includes("00D4FF") ? "#00D4FF" : useCase.color.includes("00FF88") ? "#00FF88" : useCase.color.includes("8B5CF6") ? "#8B5CF6" : "#F472B6"}20, transparent)`,
                    }}
                  >
                    <useCase.icon
                      className="w-6 h-6"
                  ...
                  <h3 className="mt-4 text-xl font-semibold text-white group-hover:text-[#00D4FF] transition-colors">
                    {useCase.title}
                  </h3>
                  <p className="mt-2 text-gray-400">{useCase.description}</p>
                  <div className="mt-4 flex items-center text-[#00D4FF] text-sm font-medium">
                    Learn more
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-16">
            <div className="relative p-8 rounded-xl bg-[#14141A] border border-white/10 max-w-md mx-auto">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-[#0A0A0F] text-sm font-bold">
                Connect
              </div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Act */}
              <div className="relative p-8 rounded-xl bg-[#14141A] border-2 border-[#00FF88]/30">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-[#00FF88] text-[#0A0A0F] text-sm font-bold">
                  Act
                </div>
                <div className="mt-4 flex justify-center">
              ...
              {/* Learn */}
              <div className="relative p-8 rounded-xl bg-[#14141A] border-2 border-[#8B5CF6]/30">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-[#8B5CF6] text-[#0A0A0F] text-sm font-bold">
                  Learn
                </div>
                <div className="mt-4 flex justify-center">
      ...
      <section className="py-12 md:py-20 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 1 }}
            animate={{ opacity: 1 }}
            className="relative rounded-2xl overflow-hidden p-8 md:p-12 bg-gradient-to-r from-[#00D4FF]/10 to-[#8B5CF6]/10 border border-white/10"
          >
          ...
          >
            ...
            <div className="relative z-10 px-8 py-16 md:px-16 md:py-20 text-center">
              ...
              <div className="mt-8">
                <Link
                  href="/contact"
                  className="inline-flex px-8 py-4 text-base font-semibold rounded-lg bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-[#0A0A0F] hover:opacity-90 transition-all hover:scale-105"
                >
                  Let&apos;s Talk
                </Link>
              </div>
